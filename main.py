try:
    ...
    while True:
        ...
        if choice == "1":
            ...
            num_3 = int(input("Subtrahend: "))
            num_4 = int(input("Minus: "))
            num_3_4  = num_3 - num_4
            print(str(num_3) + " - " + str(num_4) + " = " + str(num_3_4))
            print("choice from 1 to 6 ")
        elif choice == "3":
            num_5 = int(input("First factor number: "))
            num_6 =int(input("Second factor number: "))
            num_5_6  = num_5 * num_6
            print(str(num_5) + " * " + str(num_6) + " = " + str(num_5_6))
            print("choice from 1 to 6 ")
        elif choice == "4":
            num_7 = int(input("Dividend: "))
            num_8 = int(input("Divisor: "))
            num_7_8 = num_7 / num_8
            print(str(num_7) + " / " + str(num_8) + " = " + str(num_7_8))
            print("choice from 1 to 6 ")
        elif choice == "5":
            num_9 = int(input("Dividend: "))
            num_10 = int(input("Divisor: "))
